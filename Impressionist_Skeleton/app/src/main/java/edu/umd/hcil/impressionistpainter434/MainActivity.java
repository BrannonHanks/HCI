...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuLine:
                ...
                return true;
            case R.id.menuCircleVelocity:
                Toast.makeText(this, "Circle Velocity Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.CircleVelocity);
                return true;
            case R.id.menuSquareVelocity:
                Toast.makeText(this, "Square Velocity Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.SquareVelocity);
                return true;
        }
        return false;
    }
    ...
    //the onclick function for bitmap saving
    public void onButtonClickSaveImage(View v) {
        FileUtils.verifyStoragePermissions(this);
        MediaStore.Images.Media.insertImage(getContentResolver(), _impressionistView.save(), "img1", "People");
