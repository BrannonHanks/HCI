...
public class DoodleView extends View {
    ...
    public void setAlpha (int r, TextView temp) {
        opaC = r;
    ...
    public void setRed (int r, TextView temp1, TextView temp) {
        redC = r;
    ...
    public void setGreen (int r, TextView temp1, TextView temp) {
        greenC = r;
    ...
    public void setBlue (int r, TextView temp1, TextView temp) {
        blueC = r;
    ...
    public void setBoxes (TextView r,TextView g,TextView b, TextView rgb) {
        r.setBackgroundColor(android.graphics.Color.argb(opaC, redC, 0, 0));
        g.setBackgroundColor(android.graphics.Color.argb(opaC, 0, greenC, 0));
        b.setBackgroundColor(android.graphics.Color.argb(opaC, 0, 0, blueC));
        rgb.setBackgroundColor(android.graphics.Color.argb(opaC, redC, greenC, blueC));
    }
}
