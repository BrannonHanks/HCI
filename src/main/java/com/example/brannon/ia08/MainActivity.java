...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redT = (TextView) findViewById(R.id.redBox);
        greenT = (TextView) findViewById(R.id.greenBox);
        blueT = (TextView) findViewById(R.id.blueBox);
        finT = (TextView) findViewById(R.id.finalBox);
        can.setBoxes(redT, greenT, blueT, finT);
